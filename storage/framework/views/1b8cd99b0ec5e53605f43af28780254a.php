...
$(function(){
    ...
    var id = $(this).data('id');
    $.get("<?php echo e(route('products.edit', ['product' => 'id'])); ?>".replace('id', id), function(data){
    ...
    var url = $('#savedata').val() === 'create-product' ? "<?php echo e(route('products.store')); ?>" : "<?php echo e(route('products.store', ['product' => 'id'])); ?>";
    ...
    $('body').on('click', '.deleteProduct', function(){
        if(confirm("Are you sure you want to delete this product?")) {
            var id = $(this).data('id');
            $.ajax({
                url: "<?php echo e(route('products.index')); ?>/" + id,
                type: 'DELETE',
                success: function(data) {
                    fetchProducts();
                },
...
<?php /**PATH C:\Users\Q278\product-crud\resources\views/productAjax.blade.php ENDPATH**/ ?>